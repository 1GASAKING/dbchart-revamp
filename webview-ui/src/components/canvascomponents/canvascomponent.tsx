import { useEdgesState, useNodesState, Position, MiniMap, type Connection, addEdge, type ReactFlowInstance, ControlButton } from "@xyflow/react"
import { CanvasComponentMainDiv, CanvasComponentReactFlow, CanvasComponentControls } from "../../styles/canvascomponentstyles/canvascomponentstyles"
        ...
        <ToastProvider>
            <CanvasComponentMainDiv>
                <CanvasComponentReactFlow
                    ...
                    <CanvasComponentControls showInteractive={true} position="bottom-center" orientation="horizontal" >
                        <ControlButton>
                            d
                        </ControlButton>
